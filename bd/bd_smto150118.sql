-- --------------------------------------------------------
-- Host:                         127.0.0.1
-- Versión del servidor:         5.5.54-MariaDB - mariadb.org binary distribution
...
-- Volcando datos para la tabla bd_smto.area: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_smto.atributo: ~401 rows (aproximadamente)
...
INSERT INTO `atributo` (`seq_atrib_id`, `atributo`, `valor`, `activo`, `insert_oper`, `insert_datetime`, `update_oper`, `update_datetime`) VALUES
	...
	(23, 'Estado', 'CANCELADO', 'N', 'esistemas', '2014-12-10 10:16:58', 'esistemas', '2014-12-29 09:01:56'),
	...
	(287, 'Tipo', 'CUARTO ELECTRICO', 'S', 'esistemas', '2014-12-23 15:20:58', 'esistemas', '2014-12-23 15:20:58'),
	...
	(415, 'ZONA DE PONTENCIA', 'CALDERA ACEITE TERMICO - TUBERIA', 'S', 'esistemas', '2014-12-24 11:01:18', 'esistemas', '2014-12-24 11:01:18'),
...
-- Volcando datos para la tabla bd_smto.hist_pass: ~24 rows (aproximadamente)
...
INSERT INTO `operador` (`operador_id`, `ape_y_nom`, `sector_id`, `e_mail`, `contrasenia`, `privado`, `nivel`, `expira_clave`, `avisar_asignado`, `avisar_solicitud`, `insert_oper`, `insert_datetime`, `update_oper`, `update_datetime`) VALUES
	...
	('aluna', 'LUNA CASTILLO ANIBAL', '02', 'sistemas.alc@realsa.co', 'e10adc3949ba59abbe56e057f20f883e', 'S', 20, '2018-03-13', 'N', 'N', 'jmto', '2014-12-09 13:35:17', 'aluna', '2018-01-12 16:08:18'),
...
-- Volcando datos para la tabla bd_smto.sigo_ticket: ~21 rows (aproximadamente)

    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody id="tbody_elementos" accion="listar_planta">
	...
	<div id="addElementoModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <div class="form-group">
							<label>Nombre</label>
							<input id="txtNombreInsert" type="text" maxlength="100" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Descripcion</label>
              <input id="txtDescripcionInsert" type="text" maxlength="100" class="form-control">
						</div>
					</div>
					<div class="modal-footer">
            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
						<input id="btnSave" accion="insert_planta" type="submit" class="btn btn-info" value="Guardar">
					</div>
				</form>
			</div>
		</div>
	...
	<div id="editElementoModal" class="modal fade">
        ...
        <form>
					...
					<div class="modal-body">
						<div class="form-group">
							<label>Nombre</label>
							<input id="txtNombreEdit" type="text" maxlength="100" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Descripcion</label>
              <input id="txtDescripcionEdit" type="text" maxlength="100" class="form-control">
						</div>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
						<input id="btnEditElemento" type="submit" id_elemento="" accion="edit_planta" class="btn btn-info" value="Guardar">
					</div>
        </form>
			</div>
		</div>
		...
		<div class="modal-dialog">
            ...
            <p  class="text-warning">Descripcion: <small id="lblDescripcionDelete"></small></p>
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-danger" id="btnDeleteElemento" id_elemento="" accion="delete_planta" value="Eliminar">
					</div>
				</form>
			</div>
		</div>

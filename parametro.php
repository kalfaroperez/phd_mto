...
/*
    ...
    Funci�n: Controlador del archivo de par�metros
...
## Primero verfico que se haya ingresado por "guardar", si no es as�
...
$query="UPDATE {$MyPHD}parametros SET
     ...
     $_SESSION['PHD_SUBCARPETA_ADJUNTO_FICHA_TEC']=$subcarpeta_adjunto_ficha_tec;
